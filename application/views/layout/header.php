...
<head>
    ...
    <title>Apolo Park&nbsp;|&nbsp;<?php echo (isset($titulo) ? $titulo : 'Um novo conceito em estacionamentos');?></title><!--se a var titulo estiver setado imprima o titulo se nao imprimira Um novo conceito em estacionamentos-->
    ...
    <?php if(isset($styles)): ?><!--Se $style estiver setada-->
        <?php foreach ($styles as $style) :?><!--Para cada variavel style chame a de style -->
            <link rel="stylesheet" href="<?php echo base_url('public/'.$style);?>"><!--e imprima todos os estilos contidos-->
        <?php endforeach; ?>
    <?php endif; ?>
</head>
